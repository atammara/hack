...
const Homehero = () => {
  return (
    <div>
      ...
      {/* Product Showcase */}
      <section className="py-10 px-6 lg:py-16 lg:px-28">
        <div className="max-w-6xl mx-auto text-start">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Product Items */}
            {[
              { name: "Comfy Chair", Image: "/chair.png", price: "$250" },
              { name: "Rustic Vase Set", Image: "/vas.png", price: "$155" },
              { name: "Stoneware Pitcher", Image: "/pot.png", price: "$125" },
              { name: "Pendant Lamp", Image: "/lamp.png", price: "$399" },
            ].map((product, index) => (
              <div
                key={index}
        ...
        <div className="flex justify-center mt-14">
          <button className="px-6 py-4 text-lg bg-[#F9F9F9] shadow hover:bg-gray-200 transition">
            View Collection
          </button>
        </div>
      </section>
